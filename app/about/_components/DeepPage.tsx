...
export type DeepPageProps = {
  slug: "how-it-works" | "clinical-excellence" | "innovation" | "quality-and-safety";
  eyebrow: string;
  title: string;
  titleAccent: string;
  missionParts: MissionWord[];
  pillarsEyebrow: string;
  pillarsHeading: string;
  pillarsHeadingAccent: string;
  pillarsLead: string;
  pillars: Pillar[];
  listHeading: string;
  list: string[];
...
// Doctor avatar images (reused across deep pages)
const ARC_IMAGES = [
