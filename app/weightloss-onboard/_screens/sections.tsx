...
import type { ScreenId } from "../schema";
...
export const SECTIONS_ORDER: SectionKey[] = [
  "weight", "meds", "id", "bariatric",
  "medical", "safety", "lifestyle", "profile",
];

export const SECTION_INFO: Record<SectionKey, { label: string; short: string }> = {
...
export const SECTION_SCREENS: Record<SectionKey, ScreenId[]> = {
  weight:    ["s4", "s5", "s6"],
...
export function SectionStepper({ section, currentScreen: _currentScreen }: SectionStepperProps) {
