...
export const MIN_AGE_YEARS: number = 18;
...
export function validateImageUpload(file: File | undefined): string | null {
  if (!file) return null;
...
export function getCurrentLbs(form: Form): number {
...
export function estimateLossLbs(form: Form, currentLbs: number): number {
  switch (form.s1) {
    case "1–15 lbs.":
      return 8;
    case "16–50 lbs.":
