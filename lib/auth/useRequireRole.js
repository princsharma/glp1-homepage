...
// never see anything about clinician registration. Admin login is also
// segregated (and unlinked from the public site) so the URL is harder
// to guess for casual probing.
const ROLE_LOGIN = {
  patient: "/login",
  doctor: "/doctor/doctor-login",
